...
namespace gabriela_duarte.Controllers
{
    public class PagamentoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PagamentoId,DataLimite,Valor,Pago,NotaDeVendaId")] Pagamento pagamento)
        {
            ...
            ViewData["NotaDeVendaId"] = new SelectList(_context.NotaDeVenda, "NotaDeVendaId", "NotaDeVendaId", pagamento.NotaDeVendaId);
            return View(pagamento);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PagamentoId,DataLimite,Valor,Pago,NotaDeVendaId")] Pagamento pagamento)
        {
